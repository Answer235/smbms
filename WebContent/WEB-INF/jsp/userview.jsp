 ...
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p>
            	<strong>身份证：</strong>
            	<span>
            		<img src="${pageContext.request.contextPath }/static/upload/${user.idPicPath}" width="200px" height="300px"/>
            	</span>
            </p>
            <p>
            	<strong>工作证：</strong>
            	<span>
            		<img src="${pageContext.request.contextPath }/static/upload/${user.workPicPath}" width="200px" height="300px"/>
            	</span>
            </p>
